 ...
 *
 * <p>{@code messageBroker kafka} in {@code jdl/payout.jdl} makes the generator emit
 * {@code HealthconnectPayoutKafkaResource} beside the entity CRUD D54 deleted. It carried three
 ...
 * {@code /services/healthconnectpayout/api/**} straight at it.
 *
...
class KafkaSampleIsNotAnApiIT {
    ...
    private static final String SAMPLE = "/api/healthconnect-payout-kafka";
