 ...
 *
 * <p>{@code messageBroker kafka} in {@code jdl/messaging.jdl} makes the generator emit
 * {@code HealthconnectMessagingKafkaResource} beside the entity CRUD D54 deleted. It carried three
 ...
 * {@code /services/healthconnectmessaging/api/**} straight at it.
 *
 ...
 *
 * <p>This is a <strong>new file</strong>, so {@code jhipster jdl ../jdl/messaging.jdl --force} leaves it
...
class KafkaSampleIsNotAnApiIT {
    ...
    private static final String SAMPLE = "/api/healthconnect-messaging-kafka";
