...
import net.jojoaddison.service.BookingQueryService;
import net.jojoaddison.service.BookingService;
...
/**
 * REST controller for managing {@link net.jojoaddison.domain.Booking}.
 */
@RestController
...
public class BookingResource {
    ...
    private static final String ENTITY_NAME = "healthconnectBookingBooking";
