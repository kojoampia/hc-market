...
public record PaymentOutcome(PaymentState state, String providerReference, String reason, PaymentNextAction nextAction) {
    ...
    /**
     * A refusal with no handle. See {@link #failed(String)} — the same caution applies, for the same
     * reason.
     */
     ...
     * keep, and no {@code payment_attempt} row exists yet for it to have named.
     *
     * <p><strong>It is wrong in {@link PaymentProvider#readCallback}, and it is the obvious thing to
